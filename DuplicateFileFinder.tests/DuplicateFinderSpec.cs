...
namespace DuplicateFileFinder.tests
{
	public class DuplicateFinderSpec
	{
		...
		private void DeleteFileIgnoreExceptions(string path)
		{
			try
			{
				File.Delete(path);
			...
			{
				// Do nothing - we don't care about exceptions failing in cleanup for a test
			}
		}
		...
		{
			DeleteFileIgnoreExceptions(AppDomain.CurrentDomain.BaseDirectory + "Duplicate1.txt");
			DeleteFileIgnoreExceptions(AppDomain.CurrentDomain.BaseDirectory + "Duplicate2.txt");
			DeleteFileIgnoreExceptions(AppDomain.CurrentDomain.BaseDirectory + "Unique.txt");
			DeleteFileIgnoreExceptions(AppDomain.CurrentDomain.BaseDirectory + "/SF1/SF2/Duplicate1.txt");
			DeleteFileIgnoreExceptions(AppDomain.CurrentDomain.BaseDirectory + "Unique1.txt");
			DeleteFileIgnoreExceptions(AppDomain.CurrentDomain.BaseDirectory + "/SF1/SF2/Unique1.txt");
			DeleteFileIgnoreExceptions(AppDomain.CurrentDomain.BaseDirectory + "Unique2.txt");
			DeleteFileIgnoreExceptions(AppDomain.CurrentDomain.BaseDirectory + "Unique3.txt");
		}
		...
		public void ShouldFindNoDuplicatesIn2LevelSubFolder()
		{
			...
			// Create 3 files, none of which are duplicates
			Directory.CreateDirectory(AppDomain.CurrentDomain.BaseDirectory + "/SF1/SF2/");
